const Icons = () =>{
    return (
        <svg style={{display: 'none'}}>
            ...
            <symbol id="khanegibarghimain" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25">
                <path
                    d="M5.738 5.989v2.99h-1.5V5.99h1.5zM5.738 12.968v2.991h-1.5v-2.991h1.5zM18.806 20.793a.877.877 0 11-1.754 0 .877.877 0 011.754 0z"></path>
                <path fillRule="evenodd"
            ...
            <symbol id="vehicle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
            ...
            <symbol id="roosta" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
                    d="M15.5 1v3l-3 3V4l3-3zM11.5 9v2.984L8.5 9v3l3 3v8.005L7 23l-.5-1C8 22 9 21.395 9 20c0-1.6-1.12-2.72-2.464-4.064C4.52 13.92 2 11.4 2 6h6.5l3 3zM12.5 9v2.984L15.5 9v3l-3 3v8.005L17 23l.5-1C16 22 15 20.895 15 19.5c0-1.6 1.12-2.64 2.464-3.888C19.48 13.74 22 11.4 22 6h-6.5l-3 3zM8.5 4V1l3 3v3l-3-3z"></path>
            </symbol>
            ...
            <symbol id="deliveryToday" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <path fillRule="evenodd" d="M7 12V9.75H5.5v3c0 .414.336.75.75.75h3V12H7z" clipRule="evenodd"></path>
            </symbol>
            ...
            <symbol id="addSimple" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path fillRule="evenodd" d="M13 4h-2v7H4v2h7v7h2v-7h7v-2h-7V4z" clipRule="evenodd"></path>
            </symbol>
