      ...
      {isTopLevel || hasChildren ? (
        <Link
          ...
          className={`group relative flex items-center hover:text-primary-500 
                    ${
                      isTopLevel
                        ? "before:content-[''] pr-2 before:w-[2px] before:bg-primary-500 before:h-[14px] before:absolute before:right-0"
                        : ""
                    }
        ...
        >
          {category.title}
          <svg
            className="group-hover:fill-primary-500 fill-neutral-900"
            width={"16px"}
            height={"16px"}
          >
        ...
        <Link
          href={"#"}
          className="text-neutral-500 py-1 hover:text-primary-500 text-body-2"
          key={category.id}
        >
          {category.title}
        </Link>
...
export default memo(RecursiveCategoryItem);
