...
import SpecialSellBadge from "../specialSellBadge";
...
const ProductItem = ({ product }: { product: Product }) => {
  return (
    ...
    >
      <article
        className={
          "overflow-hidden flex flex-col items-stretch justify-start h-full"
        }
      >
        <SpecialSellBadge
          isBannerVisible={product.default_variant.price?.discount_percent > 0}
        />
        <div className="flex grow relative flex-col">
          <div className="flex items-start mx-auto mb-1">
            <Image
              className="w-full rounded-medium inline-block object-contain"
          ...
          <div className="grow flex flex-col items-stretch justify-start">
            ...
            <h3 className="ellipsis-2 text-body2-strong text-neutral-700 h-[52px]">
              {product.title_fa}
            </h3>
            <div className="mb-1 flex items-center justify-between">
                ...
                {product.default_variant.shipment_methods?.has_lead_time ? (
                  <>
                    <svg
                      width={18}
                      height={18}
                      className={"fill-icon-delivery-jet-expansion ml-1"}
                    >
              ...
              <div className="flex items-center">
                <p className="text-caption-strong text-neutral-700">
                ...
                <div className="flex mr-2 shrink-0">
                  <svg
                    width={16}
                    height={16}
                    className={"fill-icon-rating-0-2"}
                  >
