...
const BestSellersProductCard = ({
  ...
  return (
    <Link
      className={`flex  ${styles.products_container}`}
    ...
    >
      ...
      <span className="text-secondary-500 text-h2-extra ml-3 flex items-center">
        {toFarsiNumber(counter)}
      </span>
      <div
        className={`grow flex flex-col justify-center relative ${styles.product_item}`}
      >
